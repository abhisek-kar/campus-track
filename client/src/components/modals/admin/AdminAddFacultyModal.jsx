...
const AdminAddFacultyModal = ({ onClose, edit }) => {
  ...
  const formik = useFormik({
    initialValues: {
      name: edit ? currentFaculty?.name : "",
      email: edit ? currentFaculty?.email : "",
      password: "",
      address: edit ? currentFaculty?.address : "",
      mobile: edit ? currentFaculty?.mobile : "",
    },
      ...
      >
        ...
        >
          ...
          <div className=" poppins-extrabold mb-8 text-xl text-gray-700">
            {!edit ? "Create A  Faculty" : "Edit Faculty Details"}
          </div>
          <Toaster />
          {/* body */}
          <div className="mb-6 ">
...
export default AdminAddFacultyModal;
