...
const DashboardHeader = ({ onClick, role, userName, children }) => {
  return (
    <div className=" flex items-center justify-between p-2 shadow-md w-full z-30 fixed bg-white">
      <div>{children}</div>
      <div className="flex items-center gap-5 mr-5">
        ...
        <div className="flex items-center bg- pr-2 bg-slate-200 pl-1 py-1 rounded-full ">
